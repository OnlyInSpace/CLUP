...
export default function Login({ history }) {
    //TODO: Ensure user does not go over max partyAmount allowed
...
const VisitContent = ({handleSubmit, scheduledDate, setScheduledTime, scheduledTime, setPartyAmount, setScheduledDay}) => {
