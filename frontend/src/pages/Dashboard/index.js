...
function Dashboard() {
  ...
  async function handleClockInOut() {
    ...
    try {
      ...
      await api.post(clockInOut, {user_id}, { headers });
      handleClose();
  ...
  async function changeOccupancy() {
    try {
      ...
      const newStoreData = await api.put('/changeCount', { store_id, occupancyChangeValue, storeData }, { headers });
      handleClose();
  ...
  async function joinQueue() {
    try {
      ...
      let joinQueue = await api.put('/queue/append', { customer, store_id, storeData }, { headers });
      handleClose();
  ...
  async function cancelVisit() {
    try {
      ...
      const response = await api.delete(`/myvisits/${visit_id}`, { headers });
      handleClose();
