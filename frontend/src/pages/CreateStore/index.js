...
//    ex: For maxikmum amount of customer allowed to visit one group    (?)
          // (*once icon clicked reveal this message*): We know that customers can either come alone or in group with one or more person.
          //                                            This option sets how large that group can be. For instance, if you only want customers 
          //                                            to arrive alone, then this option to be set to one. However, if you want customers to 
          //                                            arrive groups of up to 6, then this option would be set to 6. We will make sure customers
