  ...
  const handleSubmit = async (evt) => {
    ...
    try {
      ...
      if (!storeName || !maxOccupants || !maxPartyAllowed || !city || !state || !address1 || !postalCode || !avgVisitLength) {
        ...
        let response = await api.post('/store/create', { owner_id, storeName, location, maxOccupants, maxPartyAllowed, avgVisitLength, open24hours, businessHours }, { headers: {'accessToken': accessToken }});
      ...
      <div className="content">
        ...
        <Form className="createStoreForm" onSubmit = {handleSubmit}>
          ...
          <Form.Group controlId="formAvgLength">
            ...
            <Form.Control type='number' placeholder="Minutes" onChange={evt => setAvgVisitLength(evt.target.value)} />
          </Form.Group>
